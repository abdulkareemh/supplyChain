...
@section('content')
<div class="">
    <a class="btn btn-primary" href="/suppliers/create" style="color: white;">Create</a>
</div>
<div class="row">
            ...
            <table class="table  mb-5" id="clientsTable">
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    <tr>
                        ...
                        <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{$Supplier->email}}</strong></td>

                        <td>{{$Supplier->phone}}</td>
                        <td>{{$Supplier->number_of_orders}}</td>
                        <td>{{$Supplier->city}}</td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{url('suppliers/'.$Supplier -> id.'/edit')}}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                    <a class="dropdown-item" href="{{url('suppliers/'.$Supplier -> id)}}"><i class="bx bx-trash me-1"></i> show</a>
                                </div>
                            </div>
                        </td>
                    </tr>
